 ...
 */
public class ItemViewHolder extends MultiLayoutView.ViewHolder  {
     ...
     */
    public ItemViewHolder setText(@IdRes int viewId, CharSequence value) {
        TextView view = getView(viewId);
        view.setText(value);
        return this;
    }

    public ItemViewHolder setText(@IdRes int viewId, @StringRes int strId) {
        TextView view = getView(viewId);
        view.setText(strId);
        return this;
    }
     ...
     * @return The ItemViewHolder for chaining.
     */
    public ItemViewHolder setImageResource(@IdRes int viewId, @DrawableRes int imageResId) {
     ...
     * @return The ItemViewHolder for chaining.
     */
    public ItemViewHolder setBackgroundRes(@IdRes int viewId, @DrawableRes int backgroundRes) {
        View view = getView(viewId);
     ...
     * @return The ItemViewHolder for chaining.
     */
    public ItemViewHolder setTextColor(@IdRes int viewId, @ColorInt int textColor) {
        TextView view = getView(viewId);
     ...
     * @return The ItemViewHolder for chaining.
     */
    public ItemViewHolder setVisible(@IdRes int viewId, boolean visible) {
        View view = getView(viewId);
     ...
     */
    public ItemViewHolder setTypeface(@IdRes int viewId, Typeface typeface) {
        TextView view = getView(viewId);
    ...
    public ItemViewHolder addOnClickListener(@IdRes final int viewId) {
     ...
     */
    @SuppressWarnings("unchecked")
    public ItemViewHolder addOnLongClickListener(@IdRes final int viewId) {
     ...
     */
    @Deprecated
    public ItemViewHolder setOnItemClickListener(@IdRes int viewId, AdapterView.OnItemClickListener listener) {
     ...
     */
    @SuppressWarnings("unchecked")
    public ItemViewHolder setAdapter(@IdRes int viewId, Adapter adapter) {
        AdapterView view = getView(viewId);
     ...
     * @return The ItemViewHolder for chaining.
     */
    public ItemViewHolder setOnItemLongClickListener(@IdRes int viewId, AdapterView.OnItemLongClickListener listener) {
        AdapterView view = getView(viewId);
     ...
     * @return The ItemViewHolder for chaining.
     */
    public ItemViewHolder setOnItemSelectedClickListener(@IdRes int viewId, AdapterView.OnItemSelectedListener listener) {
        AdapterView view = getView(viewId);
