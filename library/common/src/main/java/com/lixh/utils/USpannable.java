 ...
 */
public class USpannable extends SpannableStringBuilder {
    ...
    public USpannable(CharSequence text) {
        super(text);
    }

    public USpannable(CharSequence text, Object... spans) {
        super(text);
    ...
    public USpannable(CharSequence text, Object span) {
        super(text);
     ...
     * @return this {@code USpannable}.
     */
    public USpannable append(CharSequence text, Object... spans) {
        append(text);
        for (Object span : spans) {
    ...
    public USpannable append(CharSequence text, Object span) {
        append(text);
        setSpan(span, length() - text.length(), length());
        return this;
    }
     ...
     * @return this {@code USpannable}.
     */
    public USpannable append(CharSequence text, ImageSpan imageSpan) {
        text = "." + text;
        append(text);
     ...
     */
    @Override
    public USpannable append(CharSequence text) {
        super.append(text);
        return this;
    }
     ...
     */
    @Deprecated
    public USpannable appendText(CharSequence text) {
        append(text);
        return this;
    }
     ...
     * @return {@code USpannable}.
     */
    public USpannable findAndSpan(CharSequence textToSpan, GetSpan getSpan) {
        int lastIndex = 0;
        while (lastIndex != -1) {
