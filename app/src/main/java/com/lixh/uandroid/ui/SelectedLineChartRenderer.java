...
public class SelectedLineChartRenderer extends LineRadarRenderer {
    ...
    public SelectedLineChartRenderer(LineDataProvider chart, ChartAnimator animator,
    ...
    protected void drawCircles(Canvas c) {
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            for (int j = mXBounds.min; j <= boundsRangeCount; j++) {
                ...
                LineEntry e = null;
                if (dataSet.getEntryForIndex(j) instanceof LineEntry) {
                    e = (LineEntry) dataSet.getEntryForIndex(j);
                }
                if (e == null) break;
                if (!e.isDrawCircle()) {
                    continue;
